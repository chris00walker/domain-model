...
if (fs.existsSync(strategyDir)) {
  ...
  fs.writeFileSync("DDD_Artefacts/docs/analysis/phase1/event-storming-session-prep.md", md);
  ...
  console.log(chalk.yellow(`📋 Review DDD_Artefacts/docs/analysis/phase1/event-storming-session-prep.md before scheduling`));
}
